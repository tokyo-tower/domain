 ...
 * 主に車椅子などのための仮予約
 */
exports.STATUS_TEMPORARY_FOR_SECURE_EXTRA = 'TEMPORARY_FOR_SECURE_EXTRA';
/**
 * 主に車椅子などのための余分確保
 */
...
(function (REFUND_STATUS) {
    ...
    // 未指示
    REFUND_STATUS.NOT_INSTRUCTED = '1';
    // 指示済
    REFUND_STATUS.INSTRUCTED = '2';
    // 返金完了
    REFUND_STATUS.COMPLETE = '3';
...
function publishPaymentNo(date) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const no = (sequence !== null) ? sequence.get('no') : 0;
        debug('no:', no);
        // 9桁になるように0で埋める
