...
import * as TicketTypeGroupUtil from '../TicketTypeGroup/TicketTypeGroupUtil';
 ...
 * 券種(無料)
 */
export const TICKET_TYPE_CODE_FREE = '00';
/**
 * 券種(Not for sale)
 */
export const TICKET_TYPE_CODE_NOT_FOR_SALE = '99';
